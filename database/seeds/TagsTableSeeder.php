...
class TagsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $php->name = "PHP";
        $php->slug = "php";
        $php->meta_description = "Meta for PHP";
        $php->save();

        $laravel = new Tag();
        $laravel->name = "Laravel";
        $laravel->slug = "Laravel";
        $laravel->meta_description = "Meta for Laravel";
        $laravel->save();

        $symphony = new Tag();
        $symphony->name = "Symphony";
        $symphony->slug = "symphony";
        $symphony->meta_description = "Meta for Symphony";
        $symphony->save();

        $vue = new Tag();
        $vue->name = "Vue JS";
        $vue->slug = "vuejs";
        $vue->meta_description = "Meta for Vue JS";
        $vue->save();
